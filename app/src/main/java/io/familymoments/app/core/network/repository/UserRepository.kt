...
interface UserRepository {
    ...
    suspend fun executeSocialSignIn(type: String, token: String, fcmToken: String): Flow<Resource<SocialSignInResult>>
    ...
    suspend fun reportUser(userId: String): Flow<Resource<ApiResponse<String>>>
}
