...
sealed class MyPageItem(
    ...
    data object Notification:
        MyPageItem(MyPageRoute.Notification.name, R.string.my_page_label_notification, R.drawable.ic_my_page_notification)
    data object FamilyInvitationList:
        MyPageItem(MyPageRoute.FamilyInvitationList.name, R.string.my_page_label_family_invitation_list, R.drawable.ic_my_page_family_invitation_list)
    data object FamilySettings:
        MyPageItem(MyPageRoute.FamilySettings.name, R.string.my_page_label_family_settings, R.drawable.ic_my_page_family_settings)
    data object Logout:
        MyPageItem(MyPageRoute.Logout.name, R.string.my_page_label_logout, R.drawable.ic_my_page_logout)
    data object AccountDeletion:
        MyPageItem(MyPageRoute.AccountDeletion.name, R.string.my_page_label_account_deletion, R.drawable.ic_my_page_account_deletion)
}
